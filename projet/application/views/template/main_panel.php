        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle mr-lg-2" id="alertsDropdown" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <span class="indicator text-warning d-none d-lg-block">
              <?php 
                if( isset( $notifs ) && count($notifs)>1 ){
                  ?>
          ...
          <div class="dropdown-menu" aria-labelledby="alertsDropdown">
            ...
            <div class="dropdown-divider"></div> 
              ...
              <?php if( isset( $notifs ) ){
                ...
                for( $i=0;$i<min(count($notifs) , 5);++$i ){
                  ?>
                  <a class="dropdown-item" href="<?php print base_url()."enterprise/notifications/$i" ?>">
                  <span class="text-success">
                    <strong>
                      <i class="fa fa-long-arrow-up fa-fw"><?php print $notifs[$i]['type']; ?></i>
                    </strong>
                    <span class="small float-right text-muxed"><?php print $notifs[$i]['time'];?></span>
                  <div class="dropdown-message small"><?php print $notifs[$i]['desc'];?></div>
                  </span>
          ...
          -->
            ...
            <a class="dropdown-item small" href="<?php print base_url().'enterprise/notifications'?>">Tout afficher</a>
      ...
      <div class="row">
        ...
        <div class="card-body">
          <ul>
            ...
            <li><b>Adresse : </b><?php print $d->adresse?></li>
            <li><b>Heure d'ouverture: </b><?php print $d->heure_ouverture?></li>
            <li><b>Heure de fermeture: </b><?php print $d->heure_fermeture?></li>
            <?php 
            /* petit hack pour afficher correctement la date */
            $time = strtotime($d->expiration_date);
            $tm = getdate($time);
            $days = ['Dimanche','Lundi','Mardi','Mercredi','Jeudi','Vendredi','Samedi'];
            $months = [ 'Janvier','Fevrier','Mars','Avril','Mai',
                        'Juin','Juillet','Aout','Septembre','Octobre','Novembre','Decembre'];
            $goodDateFormat = $days[$tm['wday']].' '.$tm['mday'].' '.$months[$tm['mon']-1].' '.$tm['year'];
            ?>
            <li><b style="color:red">Date d'expiration de l'abonnement :</b><?php print $goodDateFormat?></li>
          </ul>
          <hr/>
          <pre>
...
-------------------------------------------------------</pre>
      ...
      <div class="card mb-3">
        ...
        <p >
          ...
          <input type="file" name="enterp-logo" /><br><br>
